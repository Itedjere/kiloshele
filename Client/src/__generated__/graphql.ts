...
export type AddSalesMutation = { __typename?: 'Mutation', addSale: { __typename?: 'Sale', _id: string, staff_assigned: string, additional_note: string, customer_name: string, customer_phone: string, customer_reference: string, date: any, payment_method: PaymentMethod, payment_status: PaymentStatus, itemSold: Array<{ __typename?: 'ItemSoldType', _id: string, cost_price: number, selling_price: number, quantity: number }> } };
...
export type SalesQuery = { __typename?: 'Query', sales: Array<{ __typename?: 'Sale', _id: string, customer_name: string, customer_phone: string, customer_reference: string, date: any, payment_method: PaymentMethod, payment_status: PaymentStatus, staff_assigned: string, additional_note: string, itemSold: Array<{ __typename?: 'ItemSoldType', cost_price: number, selling_price: number, quantity: number, _id: string, product: { __typename?: 'Product', name: string, category: string, type: ServiceOrProduct } }> }> };
